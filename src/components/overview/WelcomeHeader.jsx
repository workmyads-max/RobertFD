    ...
    >
      ...
      <div className="relative z-10 p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <motion.button
          ...
          style={{
            background: 'linear-gradient(135deg, #73ff00 0%, #a3ff4d 50%, #ccff66 100%)',
            boxShadow: '0 8px 32px rgba(115,255,0,0.45), 0 0 20px rgba(115,255,0,0.3), inset 0 1px 0 rgba(255,255,255,0.25)',
          }}>
