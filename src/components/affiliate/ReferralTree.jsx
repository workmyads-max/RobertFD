    ...
    <div className="flex items-center gap-2">
      <div className="rounded-xl px-3 py-2 flex items-center gap-2"
        ...
        <div className="w-7 h-7 rounded-lg flex items-center justify-center text-[10px] font-black flex-shrink-0"
          style={{
            background: isRoot ? `${ACCENT}20` : 'rgba(99,102,241,0.12)',
            color: isRoot ? ACCENT : '#818cf8',
          }}>
        ...
        <div className="p-6 overflow-x-auto">
          <div className="flex items-start gap-8 min-w-max pb-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              {l1Profiles.length > 10 && (
                <div className="text-[10px] font-mono text-white/15 pl-2">+{l1Profiles.length - 10} more</div>
              )}
            </div>
            ...
            {l2Profiles.length > 0 && (
              <>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {l2Profiles.length > 8 && (
                    <div className="text-[10px] font-mono text-white/15 pl-2">+{l2Profiles.length - 8} more</div>
                  )}
                </div>
              </>
            )}
            ...
            {l3Profiles.length > 0 && (
              <>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {l3Profiles.length > 6 && (
                    <div className="text-[10px] font-mono text-white/15 pl-2">+{l3Profiles.length - 6} more</div>
                  )}
                </div>
              </>
            )}
