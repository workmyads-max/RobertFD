...
export default function TravelIncentiveBanner({ onSupport }) {
  const GOLD = '#c9a227';
  const GOLD_DIM = 'rgba(201,162,39,0.4)';

  return (
    <div
      className="relative w-full overflow-hidden"
      style={{ background: 'linear-gradient(135deg, #07070a 0%, #0c0c10 100%)', border: '1px solid rgba(201,162,39,0.25)', borderRadius: '2px' }}
    >
      {/* Ambient glow */}
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 60% 70% at 90% 30%, rgba(201,162,39,0.08), transparent 65%), radial-gradient(ellipse 45% 55% at 10% 90%, rgba(201,162,39,0.04), transparent 65%)',
        }}
      />
      {/* Top hairline accent */}
      ...
      <div className="relative flex items-center gap-3 px-6 py-3.5 flex-wrap" style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
        <div className="w-8 h-8 flex items-center justify-center" style={{ border: '1px solid ' + GOLD_DIM, borderRadius: '2px' }}>
          <Plane className="w-3.5 h-3.5" style={{ color: GOLD }} />
        </div>
        <span className="px-2.5 py-0.5 text-[8px] font-bold uppercase tracking-[0.25em]" style={{ color: GOLD, border: '1px solid ' + GOLD_DIM, borderRadius: '1px', background: 'rgba(201,162,39,0.05)' }}>
          Limited-Time Offer
        </span>
      ...
      <div className="relative px-6 py-7 flex gap-8 flex-col lg:flex-row">
        ...
        <div className="flex-1 min-w-0">
          <h2 className="text-[26px] sm:text-[34px] font-light text-white leading-tight tracking-tight" style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}>
            Skip the $450. Hit{' '}
            <span className="font-semibold" style={{ color: GOLD }}>$12,500</span> in L1 sales.
          </h2>
          <h2 className="text-[26px] sm:text-[34px] font-light text-white leading-tight tracking-tight mt-0.5" style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}>
            Earn <span className="font-semibold" style={{ color: GOLD }}>$1,350</span> + a 7-Night International Tour.
          </h2>
        ...
        <div className="relative flex-shrink-0 flex flex-col items-center justify-center min-w-[170px] lg:min-w-[210px]">
          ...
          <div className="relative flex items-baseline justify-center gap-2">
            <span className="text-[90px] sm:text-[110px] font-light leading-none" style={{ color: GOLD, fontFamily: 'Georgia, "Times New Roman", serif' }}>
              7
            </span>
          </div>
          ...
          {/* Boarding pass card */}
          <div className="mt-4 px-4 py-2 flex items-center gap-2" style={{ background: 'rgba(201,162,39,0.04)', border: '1px solid ' + GOLD_DIM, borderRadius: '2px' }}>
            <Plane className="w-3.5 h-3.5" style={{ color: GOLD }} />
              ...
              <React.Fragment key={i}>
                <div className="flex-1 flex items-center gap-3 min-w-0">
                  <div className="flex flex-col items-center gap-1.5 flex-shrink-0">
                    <span className="text-[9px] font-bold tracking-widest" style={{ color: GOLD }}>{step.n}</span>
                    <div className="w-8 h-8 flex items-center justify-center" style={{ border: '1px solid ' + GOLD_DIM, borderRadius: '2px' }}>
                ...
                {i < arr.length - 1 && (
                  <div className="flex items-center self-center flex-shrink-0">
                    <div className="w-6 h-px" style={{ background: 'rgba(201,162,39,0.2)' }} />
                    <ChevronRight className="w-3.5 h-3.5" style={{ color: 'rgba(201,162,39,0.35)' }} />
                  </div>
                )}
              </React.Fragment>
            );
      ...
      {/* ── Footer strip ── */}
      <div className="relative flex items-center gap-4 px-6 py-3.5 flex-wrap" style={{ background: 'rgba(201,162,39,0.02)', borderTop: '1px solid rgba(255,255,255,0.04)' }}>
        <div className="flex items-center gap-2.5 flex-1 min-w-0">
          ...
          <p className="text-[10px] text-[#808080] leading-snug">
            ...
            <span className="font-semibold" style={{ color: GOLD }}>support@xfundedtrader.com</span>{' '}
        ...
        {onSupport && (
          <>
            ...
            <button
              ...
              style={{ border: '1px solid ' + GOLD_DIM, borderRadius: '2px', background: 'transparent' }}
