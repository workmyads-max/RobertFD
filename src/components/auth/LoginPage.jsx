    ...
    <AuthCard>
      ...
      <form onSubmit={handleLogin} className="space-y-5 mb-6">
        ...
        <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}
          ...
          className="w-full py-3.5 rounded-xl text-sm font-black text-white disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-all hover:shadow-lg hover:shadow-primary/20"
