    ...
    <div className="flex flex-col h-full min-h-0" style={{ background: '#080b15', fontFamily: "'JetBrains Mono', monospace" }}>
      ...
      <div className="hidden md:flex flex-col flex-1 overflow-hidden relative">
        ...
        <div className="flex flex-1 overflow-hidden flex-col">
          {/* Top row: Market Watch | Chart Area + Order Panel — 35% height */}
          <div className="flex min-h-0 overflow-hidden" style={{ height: '35%', borderColor: 'rgba(255,255,255,0.06)' }}>
            {/* Left: Market Watch */}
          ...
          {/* Bottom row: Full-width Positions Table — 65% height */}
          <div className="flex-1 overflow-hidden" style={{ marginTop: '-4px', height: '65%' }}>
            <PositionsTable
