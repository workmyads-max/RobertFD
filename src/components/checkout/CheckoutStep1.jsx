              ...
              <div className="border-t border-white/10 pt-4 mt-2 space-y-2">
                {order.promo_applied && (
                  <div className="flex justify-between items-center text-xs">
                    <span className="text-primary font-bold">B2G1 Promo ({order.promo_quantity}× accounts)</span>
                ...
                {order.promo_applied && order.promo_free_account_size > 0 && (
                  <div className="flex justify-between items-center text-xs">
                ...
                <div className="flex justify-between items-center pt-2 border-t border-white/10">
                  ...
                  <span className="text-3xl font-black text-primary">${(order.final_price || order.price).toLocaleString()}</span>
                </div>
              </div>
            </div>
          </div>
